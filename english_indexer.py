...
class WriteData():
	...
	def write_id_title_map(self):
		...
		with open('../output_data/english_wiki_index/id_title_map.txt', 'a') as f:
			f.write('\n'.join(temp_id_title))
			f.write('\n')
	...
	def write_intermed_index(self):
		...
		with open(f'../output_data/english_wiki_index/index_{num_files}.txt', 'w') as f:
			f.write('\n'.join(temp_index))
	...
	def write_final_files(self, data_to_merge, num_files_final):
		...
		with open('../output_data/english_wiki_index/tokens_info.txt', 'a') as f:
	...
	def write_diff_postings(self, tag_type, final_tag, num_files_final):
		...
		with open(f'../output_data/english_wiki_index/{tag_type}_data_{str(num_files_final)}.txt', 'w') as f:
			f.write('\n'.join(final_tag))
...
class MergeFiles():
	...
	def merge_files(self):
		...
		while i < self.num_itermed_files:
			...
			files_data[i] = open(f'../output_data/english_wiki_index/index_{i}.txt', 'r')
...
if __name__=='__main__':
	...
	with open('../output_data/english_wiki_index/num_pages.txt', 'w') as f:
		f.write(str(num_pages))

	num_tokens_final = 0
	with open('../output_data/english_wiki_index/tokens_info.txt', 'r') as f:
		for line in f:
			num_tokens_final+=1

	with open('../output_data/english_wiki_index/num_tokens.txt', 'w') as f:
		f.write(str(num_tokens_final))

	char_list = [chr(i) for i in range(97,123)]
	num_list = [str(i) for i in range(0,10)]

	with open(f'../output_data/english_wiki_index/tokens_info.txt', 'r') as f:
		for line in tqdm(f):
			if line[0] in char_list:
				with open(f'../output_data/english_wiki_index/tokens_info_{line[0]}.txt', 'a') as t:
					t.write(line.strip())
					t.write('\n')
				...
				with open(f'../output_data/english_wiki_index/tokens_info_others.txt', 'a') as t:
					t.write(line.strip())
					t.write('\n')

	for ch in tqdm(char_list):
		tok_count = 0
		with open(f'../output_data/english_wiki_index/tokens_info_{ch}.txt', 'r') as f:
			for line in f:
				tok_count+=1

		with open(f'../output_data/english_wiki_index/tokens_info_{ch}_count.txt', 'w') as f:
			f.write(str(tok_count))

	for num in tqdm(num_list):
		tok_count = 0
		with open(f'../output_data/english_wiki_index/tokens_info_{num}.txt', 'r') as f:
			for line in f:
				tok_count+=1

		with open(f'../output_data/english_wiki_index/tokens_info_{num}_count.txt', 'w') as f:
			f.write(str(tok_count))

	try:
		tok_count = 0
		with open('../output_data/english_wiki_index/tokens_info_others.txt', 'r') as f:
			tok_count+=1

		with open(f'../output_data/english_wiki_index/tokens_info_others_count.txt', 'w') as f:
			f.write(str(tok_count))
	except:
		pass
